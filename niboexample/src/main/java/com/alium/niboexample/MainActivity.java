...
//                .setSecondaryPolyLineColor(R.color.colorAccent)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == 300) {
            ...
            Toast.makeText(this, selectedOriginDestination.getOriginFullName() +"LatLong: " +selectedOriginDestination.getOriginLatLng()+ " - " + selectedOriginDestination.getDestinationFullName(), Toast.LENGTH_LONG).show();
        } else {
