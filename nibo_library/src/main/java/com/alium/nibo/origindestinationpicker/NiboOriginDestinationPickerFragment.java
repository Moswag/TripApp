...
public class NiboOriginDestinationPickerFragment extends BaseNiboFragment<OriginDestinationContracts.Presenter> implements OriginDestinationContracts.View {
    ...
    private EditText mOriginEditText, mDestinationEditText;
    private TextView startDate, endDate,jny_start_time;
    ...
    private void initView(View convertView) {
        ...
        this.startDate=convertView.findViewById(R.id.start_date);
        this.endDate=convertView.findViewById(R.id.end_date);
        this.jny_start_time=convertView.findViewById(R.id.jny_start_time);
        ...
        jny_start_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(getActivity(),
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay,
                                ...
                                jny_start_time.setText(hourOfDay + ":" + minute);
                            }
                        }, mHour, mMinute, false);
    ...
    public void sendResults(NiboSelectedOriginDestination selectedOriginDestination){
        ...
        //initialising date and time for the journey
        selectedOriginDestination.setStartDate(startDate.getText().toString());
        selectedOriginDestination.setEndDate(endDate.getText().toString());
        selectedOriginDestination.setJourneyTime(jny_start_time.getText().toString());

       // Toast.makeText(getActivity(),selectedOriginDestination.toString(),Toast.LENGTH_LONG).show();
